...
void Camera::dragMouse( int x, int y )
{
	...
	/*if (x < -50)
		ModelerApplication::Instance()->SetControlValue(HEAD_X, 50);
	else if (x > 50)
		ModelerApplication::Instance()->SetControlValue(HEAD_X, -50);
	else*/
		//ModelerApplication::Instance()->SetControlValue(HEAD_X, -x);
	...
	//ModelerApplication::Instance()->SetControlValue(HEAD_X, getAzimuth());
}
