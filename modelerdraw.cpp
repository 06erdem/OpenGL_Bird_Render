...
ModelerDrawState::ModelerDrawState() : m_drawMode(NORMAL), m_quality(MEDIUM), m_birdType(BLUE)
{
...
void setBirdType(BirdType_t birdType)
{
    ModelerDrawState::Instance()->m_birdType = birdType;
}

int getBirdType()
{
    return ModelerDrawState::Instance()->m_birdType;
}
