...
//Bird Types
inline void ModelerUserInterface::cb_blue_i(Fl_Menu_*, void*) {
	setBirdType(BLUE);
m_modelerView->redraw();
}
void ModelerUserInterface::cb_blue(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_blue_i(o, v);
}
...
inline void ModelerUserInterface::cb_yellow_i(Fl_Menu_*, void*) {
	setBirdType(YELLOW);
m_modelerView->redraw();
}
void ModelerUserInterface::cb_yellow(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_yellow_i(o, v);
}

inline void ModelerUserInterface::cb_eagle_i(Fl_Menu_*, void*) {
	setBirdType(EAGLE);
m_modelerView->redraw();
}
void ModelerUserInterface::cb_eagle(Fl_Menu_* o, void* v) {
	((ModelerUserInterface*)(o->parent()->user_data()))->cb_eagle_i(o, v);
}
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
 ...
 {"Blue Finch", 0,  (Fl_Callback*)ModelerUserInterface::cb_blue, 0, 12, 0, 0, 14, 0},
 {"Northern Cardinal", 0,  (Fl_Callback*)ModelerUserInterface::cb_red,  0, 8, 0, 0, 14, 0},
 {"American Goldfinch", 0,  (Fl_Callback*)ModelerUserInterface::cb_yellow, 0, 8, 0, 0, 14, 0},
 {"Bald Eagle", 0,  (Fl_Callback*)ModelerUserInterface::cb_eagle, 0, 136, 0, 0, 14, 0},
...
Fl_Menu_Item* ModelerUserInterface::m_controlsAnimOnMenu = ModelerUserInterface::menu_m_controlsMenuBar + 22;
